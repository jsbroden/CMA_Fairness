...
def cut_df(df, **kwargs) -> pd.DataFrame:
    # Adapted from https://datascience.stackexchange.com/questions/
    # 75787/how-to-use-columntransformer-and-functiontransformer-to-apply-the-same-function
...
class UniverseAnalysis:
    ...
    def visit_sub_universe(
        ...
        final_output = add_dict_to_df(
            final_output, fairness_dict, prefix="fair_main_"
        )
        final_output = add_dict_to_df(
